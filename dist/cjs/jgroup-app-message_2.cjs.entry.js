...
const JgroupAppMessage = class {
    ...
    render() {
        return (index$1.h("div", { key: '5cdbbfdc9f17e6d706dca8d6c635b087a958f66f', class: `border-l-4 border-solid p-4 fade-in ${this.classes.container}` }, index$1.h("div", { key: 'a683bfd2c30db4629be3ce033b350a9c16a32306', class: "flex" }, index$1.h("div", { key: '1e5f452e414fcf2db7c0f873c7df01966c46d1d3', class: "shrink-0" }, this.renderIcon('size-8')), index$1.h("div", { key: '64b583b489ac3fedf7a2e7090a8e193a55c477ce', class: "ml-3 mt-1" }, index$1.h("h3", { key: 'f38a319f91149446abeff52fbe0c56b9341bc8e2', class: `text-md font-medium ${this.classes.heading}` }, this.heading), index$1.h("div", { key: 'ade920ce3da43d9930242bdbddd0722c3ee91a98', class: `mt-2 text-md ck-content ${this.classes.message}`, innerHTML: this.message })), index$1.h("div", { key: '74084ecb488a648faaf656341fd89f516a2f7fb8', class: "ml-auto pl-3" }, index$1.h("div", { key: 'c2a8831f5e72b07d2de54f1f94d1e243108d3c56', class: "-mx-1.5 -my-1.5" }, index$1.h("button", { key: '435e3186a3649077d7a4d00ec237052a7bfc1479', type: "button", class: `inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${this.classes.button}`, onClick: () => this.dismissMessage() }, index$1.h("span", { key: '3afb70e88c6970acd36cabe40a0367f4037d3996', class: "sr-only" }, "Dismiss"), index$1.h(CloseIcon, { key: '61fd9e6cf02354a75d18f0d4cda03f0f4cbd9434', class: "size-5" })))))));
    }
};
...
const JgroupAppMessages = class {
    ...
    render() {
        return (index$1.h("div", { key: '2128d18cba0a51ecad2544b31e0474c55b3257f0', class: "grid grid-cols-1 gap-4" }, this.messages.map(message => (index$1.h("jgroup-app-message", { heading: message.title, message: message.message, type: message.type, theme: this.theme, onDismiss: () => this.onDismiss(message.id) })))));
    }
};
