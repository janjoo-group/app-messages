...
const JgroupAppMessage = class {
    ...
    render() {
        return (index$1.h("div", { key: '40279e3d6d68a186793b43e846cc330b4c43a21a', class: `border-l-4 border-solid p-4 ${this.classes.container}` }, index$1.h("div", { key: '030bc589de7290ae691a1118b7e95b9b9d305ae1', class: "flex" }, index$1.h("div", { key: '4c91fa2dace0b082065a12129e10c6e72ad70969', class: "shrink-0" }, this.renderIcon('size-8')), index$1.h("div", { key: '7ff53eb4a101b127b6fd115b3781ac285fc9ab16', class: "ml-3 mt-1" }, index$1.h("h3", { key: '560ee25ea7dd2efdd8221ffa4ecf476d91f8b4a4', class: `text-md font-medium ${this.classes.heading}` }, this.heading), index$1.h("div", { key: '285c12dae61a06d3f694e4eda7d676e55d77033b', class: `mt-2 text-md ck-content ${this.classes.message}`, innerHTML: this.message })), index$1.h("div", { key: 'd80a640734061fb6178b930feb7fa5c0ac399905', class: "ml-auto pl-3" }, index$1.h("div", { key: 'd43f884f49f04390f2ef3dd505d3cbaf71ce9d8c', class: "-mx-1.5 -my-1.5" }, index$1.h("button", { key: '06b8640c4d40d851dabbcd11ece191e2cd30cbc5', type: "button", class: `inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${this.classes.button}`, onClick: () => this.dismissMessage() }, index$1.h("span", { key: 'f02322fd8405516f38eae09794e56d8129a8f99b', class: "sr-only" }, "Dismiss"), index$1.h(CloseIcon, { key: 'c6853dca2ff4b1169d0bc3ca124fb782b040d73a', class: "size-5" })))))));
    }
};
