...
const WarningIcon = ({ class: className }) => (index$1.h("svg", { class: `${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const ErrorIcon = ({ class: className }) => (index$1.h("svg", { class: `${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const SuccessIcon = ({ class: className }) => (index$1.h("svg", { class: `${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const InfoIcon = ({ class: className }) => (index$1.h("svg", { class: `${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const CloseIcon = ({ class: className }) => (index$1.h("svg", { class: `${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const JgroupAppMessage = class {
    ...
    renderIcon(className) {
        switch (this.type) {
            case 'warning':
                return index$1.h(WarningIcon, { class: `${className} ${this.classes.icon}` });
            case 'error':
                return index$1.h(ErrorIcon, { class: `${className} ${this.classes.icon}` });
            case 'info':
                return index$1.h(InfoIcon, { class: `${className} ${this.classes.icon}` });
            case 'success':
                return index$1.h(SuccessIcon, { class: `${className} ${this.classes.icon}` });
            default:
                return null;
        }
    }
    ...
    render() {
        return (index$1.h("div", { key: '1d76f9ccccd144eaec64206a0f9914207c72b54e', class: `border-l-4 border-solid p-4 ${this.classes.container}` }, index$1.h("div", { key: 'c071ba0d174c0dd2ee4380dced7e36cca1310280', class: "flex" }, index$1.h("div", { key: 'd1425f1315ed9df97a2fe8cc505cdbdc4b98b2ad', class: "shrink-0" }, this.renderIcon('size-8')), index$1.h("div", { key: '4bfdc473c18512e1c5ab2fff996818da7e6d7a81', class: "ml-3 mt-1" }, index$1.h("h3", { key: 'f0e2c26d7f3d9479488b67fc9fce0cbbf6c70449', class: `text-md font-medium ${this.classes.heading}` }, this.heading), index$1.h("div", { key: '93ae0f9b6750d78cb29e205de3d71c41b54a68b4', class: `mt-2 text-md ck-content ${this.classes.message}`, innerHTML: this.message })), index$1.h("div", { key: '87184768e4bd33164f7340a4d0b6dd690a3f4c6c', class: "ml-auto pl-3" }, index$1.h("div", { key: 'e90107eeb70b1acb1336a338b9e9062d53b1bb8c', class: "-mx-1.5 -my-1.5" }, index$1.h("button", { key: 'f5fb4866196bbb335f03cca1808e67320db4507f', type: "button", class: `inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${this.classes.button}`, onClick: () => this.dismissMessage() }, index$1.h("span", { key: '1b66741ac3702abbdc1444f50380eecc5d3d2365', class: "sr-only" }, "Dismiss"), index$1.h(CloseIcon, { key: '090a1e43be79042a674c16726d9910f9756aef3d', class: "size-5" })))))));
    }
};
...
const JgroupAppMessages = class {
    ...
    render() {
        return (index$1.h("div", { key: '841356a1829d6b873109f3124f9538c47cf99b61', class: "grid grid-cols-1 gap-4" }, this.messages.map(message => (index$1.h("jgroup-app-message", { heading: message.title, message: message.message, type: message.type, onDismiss: () => this.onDismiss(message.id) })))));
    }
};
