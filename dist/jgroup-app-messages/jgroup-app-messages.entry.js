import { r as registerInstance, h } from './index-Cage21tp.js';
...
const JgroupAppMessages = class {
    ...
    render() {
        return (h("div", { key: '04717d8d8cfa914920913279324824420821a71f', class: `grid grid-cols-1 gap-4 ${this.messages.length > 0 ? 'mb-4' : ''}` }, this.messages.map(message => (h("jgroup-app-message", { heading: message.title, message: message.message, type: message.type, theme: this.theme, onDismiss: () => this.onDismiss(message.id) })))));
    }
};
JgroupAppMessages.style = jgroupAppMessagesCss;

export { JgroupAppMessages as jgroup_app_messages };
//# sourceMappingURL=jgroup-app-messages.entry.esm.js.map

//# sourceMappingURL=jgroup-app-messages.entry.js.map