...
const JgroupAppMessages$1 = /*@__PURE__*/ proxyCustomElement(class JgroupAppMessages extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["jgroup-app-messages", "jgroup-app-message"];
    components.forEach(tagName => { switch (tagName) {
        case "jgroup-app-messages":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, JgroupAppMessages$1);
            }
            break;
...
const JgroupAppMessages = JgroupAppMessages$1;
const defineCustomElement = defineCustomElement$1;

export { JgroupAppMessages, defineCustomElement };
