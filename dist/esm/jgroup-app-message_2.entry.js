import { h, r as registerInstance, c as createEvent } from './index-CZDkFMwQ.js';

const WarningIcon = ({ class: className }) => (h("svg", { class: `size-5 ${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const ErrorIcon = ({ class: className }) => (h("svg", { class: `size-5 ${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const SuccessIcon = ({ class: className }) => (h("svg", { class: `size-5 ${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const InfoIcon = ({ class: className }) => (h("svg", { class: `size-5 ${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
const CloseIcon = ({ class: className }) => (h("svg", { class: `size-5 ${className || ''}`, viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", "data-slot": "icon" },
...
export { JgroupAppMessage as jgroup_app_message, JgroupAppMessages as jgroup_app_messages };
//# sourceMappingURL=jgroup-app-message.jgroup-app-messages.entry.js.map

//# sourceMappingURL=jgroup-app-message_2.entry.js.map